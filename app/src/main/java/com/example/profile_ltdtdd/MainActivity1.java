...
class MainActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvCauThu = (ListView) findViewById(R.id.list_view_cauthu);
        ...
        adapter = new CauThuAdapter(MainActivity1.this,arrayCauThu);
        lvCauThu.setAdapter(adapter);

        lvCauThu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(MainActivity1.this, Detail.class);
                ...
                intent.putExtra("thong tin",cauthu.getThongtin());
        ...
        lvCauThu.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                AlertDialog.Builder b = new AlertDialog.Builder(MainActivity1.this);
